...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        final Champion selectedChampion = values.get(position);
        holder.txtHeader.setText(selectedChampion.getName());
        ...
        holder.txtFooter.setText("URL : " + selectedChampion.getDescription());
    }
